...
public class AddGlove extends javax.swing.JFrame {
    ...
    public void saveGloveToFile(){
        try{
            FileOutputStream fileStream = new  FileOutputStream("manusi.dat");
            ObjectOutputStream objectStream = new ObjectOutputStream(fileStream);
            
            for(int i=0; i<manusi.size(); i++){
                objectStream.writeObject(manusi.get(i));
            }
            objectStream.close();
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        if(denumire.getText().isEmpty() || descriereFull.getText().isEmpty() ||
            ...
            Manusi m = new Manusi(jDenumire,  jDescF, jDescS, jMarca, jImagine, jPret, disp, jCuloare, jMat, jTip);
            manusi.add(m);
            saveGloveToFile();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddGlove.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
